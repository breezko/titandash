...
| UPGRADE_SPECIFIC_ARTIFACTS | Define a list of artifacts that will be included as artifacts to be upgraded. This allows you to include different artifacts with specific tiers while upgrading. | off | evergrowing_stack |
