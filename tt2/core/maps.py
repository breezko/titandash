...
ARTIFACT_TIER_MAP = {
    ...
    "A": {
        "charged_card": IMAGE_DIR + "/artifacts/charged_card.png",
        ...
        "evergrowing_stack": IMAGE_DIR + "/artifacts/evergrowing_stack.png",
        ...
        "quill_of_scrolls": IMAGE_DIR + "/artifacts/quill_of_scrolls.png",
        "old_king's_stamp": IMAGE_DIR + "/artifacts/old_king's_stamp.png",
