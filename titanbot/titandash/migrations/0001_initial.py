    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_type', models.CharField(blank=True, max_length=255, null=True, verbose_name='Auth Type')),
                ('auth_token', models.CharField(blank=True, max_length=255, null=True, verbose_name='Auth Token')),
                ('auth_email', models.CharField(blank=True, max_length=255, null=True, verbose_name='Auth Email')),
                ('auth_expires', models.CharField(blank=True, max_length=255, null=True, verbose_name='Auth Expires')),
